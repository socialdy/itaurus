...
export function SignupForm() {
  const handleMicrosoftSignup = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
  ...
  return (
    <Card>
      ...
      <CardContent>
        <form onSubmit={handleMicrosoftSignup}>
          <div className="grid gap-6">
            <div className="grid gap-6">
              <div className="grid gap-3">
                <Label htmlFor="name">Name</Label>
                <Input id="name" type="text" name="name" placeholder="Max Mustermann" required />
              </div>
              <div className="grid gap-3">
